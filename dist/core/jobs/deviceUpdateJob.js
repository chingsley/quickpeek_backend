...
const processDeviceUpdate = (job) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId, deviceType, deviceToken, notificationsEnabled, locationSharingEnabled } = job.data;
    try {
...
exports.default = processDeviceUpdate;
